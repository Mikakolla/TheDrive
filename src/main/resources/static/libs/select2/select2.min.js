	...
	var e = function ()
		{
				...
				}, r.prototype.bind = function (t, e)
				{
					...
					}), t.on("results:select", function ()
					{
						...
						if (0 !== e.length)
						{
							...
							"true" == e.attr("aria-selected") ? l.trigger("close",
							{}) : l.trigger("select",
							{
								data: t
							})
			...
			}), e.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function (e, t, n, r)
			{
				...
				return n.Extend(i, t), i.prototype.render = function ()
				{
					...
					return e.html('<span class="select2-selection__rendered form-control"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>'), e
			...
			}), e.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function (o, c, u, r)
			{
				var d = function (e, t)
				{
					null != u.GetData(e[0], "select2") && u.GetData(e[0], "select2").destroy(), this.$element = e, this.id = this._generateId(e), t = t ||
					{}, this.options = new c(t, e), d.__super__.constructor.call(this);
				...
				}, d.prototype._registerEvents = function ()
				{
					...
					{
						var t = e.which;
						n.isOpen() ? t === r.ESC || t === r.TAB || t === r.UP && e.altKey ? (n.close(e), e.preventDefault()) : t === r.ENTER ? (n.trigger("results:select",
